...
// UPDATED replacement with improved debt logic
...
if (content.includes(searchPattern)) {
    ...
    console.log('✅ Successfully updated estudiantes.js with per-group debt logic');
} else {
    console.log('❌ Pattern not found in file');
    console.log('Checking if already updated...');
    if (content.includes('Handles per-group monthly payment status')) {
        console.log('✅ File already has the updated per-group debt logic');
    } else if (content.includes('s.lastPayment')) {
        console.log('⚠️  File has lastPayment code but not the new per-group logic');
    } else {
